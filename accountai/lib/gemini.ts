...
Examples:
"spent ₹500 groceries" → {"intent":"record_transaction","transaction":{"amount":500,"type":"expense","category":"Groceries","description":"Spent on groceries","date":"${new Date().toISOString().split('T')[0]}","customer_name":null},"customer_name":null,"invoice_action":null,"reply":"Got it! ₹500 expense under Groceries recorded. 🛒"}
"received 50000 salary" → {"intent":"record_transaction","transaction":{"amount":50000,"type":"income","category":"Salary","description":"Salary received","date":"${new Date().toISOString().split('T')[0]}","customer_name":null},"customer_name":null,"invoice_action":null,"reply":"₹50,000 salary income recorded! 💰"}
"sales to Ravi 10000 rs" → {"intent":"record_transaction","transaction":{"amount":10000,"type":"income","category":"Sales","description":"Sales to Ravi","date":"${new Date().toISOString().split('T')[0]}","customer_name":"Ravi"},"customer_name":"Ravi","invoice_action":null,"reply":"Got it! ₹10,000 sales to Ravi recorded. 📈"}
