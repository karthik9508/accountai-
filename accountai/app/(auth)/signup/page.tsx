        ...
        <div className="relative z-10 space-y-8">
          <div>
            ...
            <p className="mt-4 text-gray-400 text-base leading-relaxed max-w-sm">
              Join businesses using FintraBooks to eliminate manual bookkeeping and get instant financial clarity.
            </p>
          </div>
      ...
      <div className="flex flex-1 flex-col items-center justify-center px-6 py-12 bg-[#080c0a]">
        ...
        <div className="w-full max-w-md">
          <div className="mb-8">
            ...
            <p className="mt-1 text-sm text-gray-500">Get started with FintraBooks for free</p>
          </div>
